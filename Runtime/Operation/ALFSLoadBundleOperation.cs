...
internal class ALFSLoadBundleOperation : FSLoadBundleOperation
{
    [UnityEngine.Scripting.Preserve]
    private enum ESteps
    {
    ...
    [UnityEngine.Scripting.Preserve]
    internal ALFSLoadBundleOperation(AliPayFileSystem fileSystem, PackageBundle bundle, string packagerVersion)
    {
